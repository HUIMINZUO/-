...
Page({
  ...
  handleRemoveImg(e) {
    ...
    // 测试看看是否能够将图片的数组打印出来，不是点提交哦，是点击图片
    // console.log(index);
  ...
  handleFormSubmit(){
    ...
    chooseImgs.forEach((v,i) => {
      wx.uploadFile({
        ...
        success: (result) => {
          ...
          // 所有的图片都上传完毕才能触发,回到用户的个人中心
          if(i === chooseImgs.length - 1) {
            // 
            wx.hideLoading();
            console.log("小仙女，我错了");
            // 提交成功之后，重置页面，回到用户的个人中心
            // 将里面的信息统统清空
            this.setData({
              textVal: "",
              chooseImgs: []
    ...
    // 关闭提示
    wx.hideLoading();
    console.log("小仙女温馨提示:您仅仅提交的是文本哦");
